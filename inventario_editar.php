<?php
// Archivo: inventario_editar.php (INTELIGENTE: Solo muestra lo que corresponde)
session_start();
...
// Obtener datos del Bien y su Categoría
$stmt = $pdo->prepare("
    SELECT i.*, t.nombre as nombre_tipo 
...
// OBTENER VALORES DINÁMICOS (Los campos importados)
// Hacemos LEFT JOIN para traer la etiqueta del campo aunque el valor esté vacío
$sqlDyn = "SELECT c.id_campo, c.etiqueta, c.tipo_input, v.valor 
           FROM inventario_campos_dinamicos c 
           LEFT JOIN inventario_valores_dinamicos v ON c.id_campo = v.id_campo AND v.id_cargo = ?
           WHERE c.id_tipo_bien = ? 
                ...
                <div class="col-md-6">
                    <div class="card shadow h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold">Código Patrimonial / Serie</label>
