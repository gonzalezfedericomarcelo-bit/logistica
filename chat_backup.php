...
try {
    // Consulta para obtener las conversaciones en las que participa el usuario
    $sql = "SELECT c.id_conversacion, c.tipo, c.nombre_grupo, c.fecha_creacion 
    ...
    <div class="conversations-list" id="conversations-list">
        ...
        <ul class="list-group list-group-flush">
            ...
            <?php foreach ($conversaciones_listado as $conv): ?>
                <?php
                    // Determinar el nombre a mostrar (simplificado)
                    $nombre_display = $conv['nombre_grupo'];
                    if ($conv['tipo'] === 'individual') {
                         $nombre_display = "Chat Individual #{$conv['id_conversacion']}";
                         // Intenta mostrar el nombre del otro participante si es el chat activo
                         if ($conversacion_activa_info && $conv['id_conversacion'] == $id_conversacion_activa) {
